...
public class CreateNewJobCommand extends Command {
        ...
        public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException,
                ...
                try {
                        ...
                        if (result.has("status")) {
                                ...
                                // update job with cml - in this case no data is
                                // uploaded, because mapping between columns and
                                // CF fields is neede
                                if (extension.has("cml") && !extension.getString("cml").equals("")) {

                                        JSONObject obj_tmp = updateJobCML(job.getString("job_id"),
                                        ...
                                        // job either exist or it is created,
                                        // time to upload data
                                        if (extension.getBoolean("upload")) {
                                                ...
                                                String msg = cf_client.bulkUploadJSONToExistingJob(
                                                                job.getString("job_id"), data.toString());
        ...
        private StringBuffer generateObjectsForUpload(JSONObject extension, Project project, Engine engine)
                ...
                // if it is an existing job with existing data!, get
                ...
                for (Iterator<Integer> it = rows_indeces.iterator(); it.hasNext();) {
                        ...
                        for (int c = 0; c < column_names.length(); c++) {
                                ...
                                // TODO: if job already has data, can we use
                                // safe_name to pass field?
        ...
        private JSONObject updateJobCML(String job_id, String cml, CrowdFlowerClient cf_client) throws JSONException {
